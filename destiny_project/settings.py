"""
Django settings for destiny_project project.
...
ROOT_URLCONF = 'destiny_project.urls'
...
WSGI_APPLICATION = 'destiny_project.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.getenv('DJANGO_LOG_FILE', './destiny_project.log'),
            'formatter': 'simple'
        },
    },
    'loggers': {
